 ...
 */
public class ActiveFragment extends Fragment implements OrderListener {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        Order order = new Order(R.drawable.test_image, "Irfan Mughal", 1400, 3);
        ArrayList<Order> orderArrayList = new ArrayList<>();
        orderArrayList.add(order);
        ordersListAdapter = new OrdersListAdapter(orderArrayList, this);
